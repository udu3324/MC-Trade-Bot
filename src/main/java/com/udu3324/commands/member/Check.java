...
public class Check extends ListenerAdapter {
                ...
                public void run() {
                    try {
                        ...
                        if (ConfirmCorrect.equals("Not a IGN or UUID!")) {
                            ...
                            sendCheck(ScammerStatusDatabase.get(UUID), UUID, IGN, check);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
    ...
    public void sendCheck(boolean isScammerInDatabase, String UUID, String IGN, Message msgReplyTo) throws Exception {
